...
OLCR v0.3.8 supports macOS Apple Silicon (arm64) only. Download the release archive, then run:

```sh
cd /path/to/downloaded/archive
shasum -a 256 olcr-v0.3.8-macos-arm64.tar.gz
tar -xzf olcr-v0.3.8-macos-arm64.tar.gz
cd olcr-v0.3.8-macos-arm64
./install.sh
olcr
```
