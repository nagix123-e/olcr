...
OLCR v0.1.9 supports macOS Apple Silicon (arm64) only. Download the release archive, then run:
...
Exit any running OLCR REPL, download `olcr-v0.1.9-macos-arm64.tar.gz`, verify its SHA-256 when available, then install it:
